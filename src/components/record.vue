  ...
  <div>
		<el-card class="box-card">
			<el-breadcrumb separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>分析记录</el-breadcrumb-item>
			</el-breadcrumb>
    </el-card>
		<div class="br"></div>
    <div>
      <el-table
		  ...
		  <el-table-column
		    prop="class"
		    label="文件类别"
			:filters="[{ text: '客观数据类型', value: '客观数据类型' }, { text: '主观数据类型', value: '主观数据类型' }]"
			:filter-method="filterTag"
			width="150"
			>
			<template #default="scope">
				<el-tag
				  :type="scope.row.class === '客观数据类型' ? 'primary' : 'success'"
				  disable-transitions>{{scope.row.class}}
				</el-tag>
			</template>
		  </el-table-column>
		  <el-table-column
